...
interface BiologyResultCardProps {
  result: AssessmentResult;
  onReset: () => void;
}

const BiologyResultCard: React.FC<BiologyResultCardProps> = ({ result, onReset }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="bg-gradient-to-br from-neutral-900/50 to-neutral-800/30 rounded-3xl p-6 border border-white/10 backdrop-blur-sm">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          ...
          <div className="text-left">
            ...
            <p className="text-neutral-400 text-sm mt-1 font-coolvetica">Assessment Results</p>
          </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="sticky top-24">
            ...
            {result.uploadedImage ? (
              <div className="bg-neutral-900/50 rounded-2xl border border-white/10 overflow-hidden">
                <img 
            ...
            {result.questions && result.questions.length > 0 && (
              <div className="mt-6 bg-neutral-900/30 rounded-2xl border border-white/10 p-4">
...
const QuestionCard: React.FC<{ question: QuestionFeedback; isSelected: boolean }> = ({ question, isSelected }) => {
  const statusConfig = {
    correct: {
      icon: '✅',
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 bg-neutral-800/50 rounded-xl p-4 border border-white/5">
        ...
        <p className="text-neutral-300 text-sm font-coolvetica leading-relaxed">
      ...
      {question.status !== 'correct' && question.correctAnswer && (
        <div className="mb-4 bg-green-900/10 rounded-xl p-4 border border-green-500/20">
          ...
          <p className="text-green-300 text-sm font-coolvetica leading-relaxed">
      ...
      {question.insight && (
        <div className="bg-blue-900/10 rounded-xl p-4 border border-blue-500/20">
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              <span className="text-xs font-medium text-blue-400 uppercase tracking-wide block mb-1">AI Insight</span>
...
export default BiologyResultCard;
